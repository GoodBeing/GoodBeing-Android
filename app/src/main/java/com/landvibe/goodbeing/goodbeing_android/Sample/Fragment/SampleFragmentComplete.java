 ...
 */
public class SampleFragmentComplete extends Fragment {
    ...
    */
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState ) {
        ...
        sampleItemArrayList.add(new SampleItem(R.drawable.historyimg, "강승모-완료","2017-01-01","배송중"));
        sampleItemArrayList.add(new SampleItem(R.drawable.historyimg, "고승빈-완료","2017-02-01","배송중"));
        sampleItemArrayList.add(new SampleItem(R.drawable.historyimg, "이상직-완료","2017-03-01","배송중"));
